...
<h2><?php the_title(); ?></h2>
            <?php echo get_the_category_list(', '); ?>
                <img class="portfolio-hero" src="<?php the_field('fieldnamehere'); ?>">
                
                <p class="intro"><?php the_field('fieldnamehere'); ?></p>
    ...
    if( $my_query->have_posts() ) { ?>
        ...
        <div class="portfolio"> <!-- Using the .portfolio class to inherit styles -->
            ...
            <!-- End Related Post -->
                ...
                <!-- Begin Related Post -->
<div class="column third" style="background-image: url(<?php the_field('portfolio_feature_image_'); ?>);">
